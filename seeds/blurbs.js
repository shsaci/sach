  ...
  return knex('blurbs').del()
    .then(function () {
      return Promise.all([
        ...
        knex('blurbs').insert({blurb: 'ONE WEEK TO GO Sunday best? Not this one 😐 Next Sunday is what it\'s all about 🗓 ⏳ ⏰ 🗣 F1 IS BACK IN SEVEN DAYS 📢', entityID: 'user1', time: '1471664993538'}),
        ...
        knex('blurbs').insert({blurb: 'Who falls victim here to some vintage Vettel at Spa in 2012? 👏 More #BelgianGP riddles 🗓 ⏳ ⏰ 🗣 F1 IS BACK IN TWO DAYS 📢', entityID: 'user1', time: '1471664993648'})
      ])
    })
}
